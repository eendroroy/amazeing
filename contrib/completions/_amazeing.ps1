...
Register-ArgumentCompleter -Native -CommandName 'amazeing' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'amazeing' {
            ...
            [CompletionResult]::new('-Z', '-Z ', [CompletionResultType]::ParameterName, 'Display size')
            [CompletionResult]::new('--zoom', '--zoom', [CompletionResultType]::ParameterName, 'Display size')
            ...
            [CompletionResult]::new('-F', '-F ', [CompletionResultType]::ParameterName, 'Simulation speed')
            [CompletionResult]::new('--fps', '--fps', [CompletionResultType]::ParameterName, 'Simulation speed')
