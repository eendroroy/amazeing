...
Register-ArgumentCompleter -Native -CommandName 'amazeing' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'amazeing' {
            ...
            [CompletionResult]::new('-F', '-F ', [CompletionResultType]::ParameterName, 'Frame rate per second (controls simulation speed)')
            [CompletionResult]::new('--fps', '--fps', [CompletionResultType]::ParameterName, 'Frame rate per second (controls simulation speed)')
            [CompletionResult]::new('-E', '-E ', [CompletionResultType]::ParameterName, 'Visual effect to apply during simulation')
            [CompletionResult]::new('--effect', '--effect', [CompletionResultType]::ParameterName, 'Visual effect to apply during simulation')
