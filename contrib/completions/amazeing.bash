        ...
        amazeing__subcmd__create)
            ...
            case "${prev}" in
                ...
                -c)
                    ...
                    ;;
                --procedure)
                    COMPREPLY=($(compgen -W "bfs dfs prim iddfs greedy-best-first bidirectional-bfs beam-search bidirectional-greedy-best-first simulated-annealing-search aldous-broder bidirectional-a-start a-star" -- "${cur}"))
                    return 0
                    ;;
                -p)
                    COMPREPLY=($(compgen -W "bfs dfs prim iddfs greedy-best-first bidirectional-bfs beam-search bidirectional-greedy-best-first simulated-annealing-search aldous-broder bidirectional-a-start a-star" -- "${cur}"))
                ...
                -F)
                    ...
                    ;;
                --effect)
                    COMPREPLY=($(compgen -W "torch fish-eye glow shockwave-pulse gravity-well chromatic-wave" -- "${cur}"))
                    return 0
                    ;;
                -E)
                    COMPREPLY=($(compgen -W "torch fish-eye glow shockwave-pulse gravity-well chromatic-wave" -- "${cur}"))
