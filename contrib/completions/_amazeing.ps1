...
Register-ArgumentCompleter -Native -CommandName 'amazeing' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'amazeing' {
            [CompletionResult]::new('-B', '-B ', [CompletionResultType]::ParameterName, 'Block shape')
            [CompletionResult]::new('--block-shape', '--block-shape', [CompletionResultType]::ParameterName, 'Block shape')
