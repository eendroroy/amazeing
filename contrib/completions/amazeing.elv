...
set edit:completion:arg-completer[amazeing] = {|@words|
    ...
    var completions = [
        ...
        &'amazeing;create'= {
            ...
            cand -F 'Frame rate per second (controls simulation speed); only valid with --verbose'
            cand --fps 'Frame rate per second (controls simulation speed); only valid with --verbose'
            cand -E 'Visual effect to apply during simulation; only valid with --verbose'
            cand --effect 'Visual effect to apply during simulation; only valid with --verbose'
            cand -Z 'Display size (zoom)'
            cand --zoom 'Display size (zoom)'
            cand -C 'Color file (.toml) path'
            cand --colors 'Color file (.toml) path'
