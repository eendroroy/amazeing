...
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -s m -l maze -d 'File path to dump Maze data' -r -F
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -s Z -l zoom -d 'Display size (zoom)' -r
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -s C -l colors -d 'Color file (.toml) path' -r -F
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -s F -l fps -d 'Frame rate per second (controls simulation speed)' -r
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -s v -l verbose -d 'Show a simulation of the generation process'
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -f -a "rectangle"
complete -c amazeing -n "__fish_amazeing_using_subcommand create; and not __fish_seen_subcommand_from rectangle help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -s m -l maze -d 'File path to dump Maze data' -r -F
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -s Z -l zoom -d 'Display size (zoom)' -r
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -s C -l colors -d 'Color file (.toml) path' -r -F
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -s F -l fps -d 'Frame rate per second (controls simulation speed)' -r
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -s v -l verbose -d 'Show a simulation of the generation process'
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -f -a "rectangle"
complete -c amazeing -n "__fish_amazeing_using_subcommand C; and not __fish_seen_subcommand_from rectangle help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
